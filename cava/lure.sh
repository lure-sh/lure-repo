...
conflicts=('cava')
deps=('')
build_deps=('base-devel fftw ncurses alsa-lib iniparser autoconf-archive pkgconf')
build_deps_deb=('build-essential libfftw3-dev libasound2-dev libncursesw5-dev libpulse-dev libtool automake autoconf-archive libiniparser-dev libsdl2-2.0-0 libsdl2-dev libpipewire-0.3-dev pkgconf')
